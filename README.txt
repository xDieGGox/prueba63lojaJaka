...
a persistence unit "prueba63lojaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba63loja/pom.xml":
...
artifact ("prueba63loja.war") is already built. You can build
